    ...
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black">
      ...
      <div className="group flex items-center">
        ...
        md:group-focus-within:ml-5 md:group-focus-within:pl-0">
          <div className="w-10 items-center justify-center hidden group-focus-within:md:flex"><IoIosSearch className="text-white tex-xl"/></div>
          <input
            type="text"
        ...
        <button className="w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center border border-l-0 border-[#303030] rounded-r-3xl bg-white/[0.1]">
            <IoIosSearch className="text-white tex-xl"/>
          </button>
      </div>
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hodden rounded-full md:ml-4">
          <img className="rounded-full" src="https://xsgames.co/randomusers/assets/avatars/female/48.jpg"/>
        </div>
      </div>
    </div>
  )
